...
const DropdownSelelctBar = () => {
  ...
  const [priceValue, setPriceValue] = useState(`${t.price}`);
  const [durationValue, setDurationValue] = useState(`${t.duration}`);
  const [languageValue, setLanguageValue] = useState(`${t.language}`);
