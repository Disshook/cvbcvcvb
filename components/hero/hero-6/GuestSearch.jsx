  ...
  return (
    <div className="searchMenu-guests px-30 lg:py-20 lg:px-0 js-form-dd js-form-counters position-relative">
      <div
        ...
        data-bs-offset="0,22"
      >
        <h4 className="text-15 fw-500 ls-2 lh-16">Зочдын мэдээлэл</h4>
        <div className="text-15 text-light-1 ls-2 lh-16">
          <span className="js-count-adult">{guestCounts.Adults}</span> Том хүн -{" "}
          <span className="js-count-child">{guestCounts.Children}</span> Хүүхэд
          - <span className="js-count-room">{guestCounts.Rooms}</span> Өрөө
        </div>
      </div>
      {/* End guest */}
