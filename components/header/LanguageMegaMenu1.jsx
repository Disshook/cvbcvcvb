...
const LanguageMegaMenu = ({ textClass }) => {
  ...
  const { use: t } = Translate(); // Using destructuring for better readability
  ...
  const languageContent = [
    { id: 1, language: "English", country: "USA" },
    { id: 2, language: "Korean", country: "Korea" },
    { id: 3, language: "Mongolian", country: "Mongolia" },
  ];
