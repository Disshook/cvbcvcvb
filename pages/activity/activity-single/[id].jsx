...
const TourSingleV1Dynamic = () => {
  ...
  const fetchTravel = async () => {
    Service.travel.single(id).then((res) => setActivity(res.data));
    ...
    <>
      ...
      <section className="pt-40">
        <div className="container">
          <SlideGallery files={activity?.files} />
        </div>
      </section>
        ...
        <div className="container">
          <div className="row y-gap-30">
            <div className="col-xl-8">
                    ...
                    <div className="col-auto">
                      <div className="d-flex items-center">
                        ...
                        <div className="text-14 text-light-1 ml-10">
                          ...
                          {activity?.numberOffReviews}20 Үзсэн хүмүүс
                        </div>
                      </div>
                    </div>
                    {/* End .col */}
              ...
              <h3 className="text-22 fw-500 mt-40">Аялалын тойм</h3>
              <TourSnapShot />
              {/* End toursnapshot */}
              <div className="border-top-light mt-40 mb-40"></div>

              <Overview description={activity?.description} />
              {/* End  Overview */}
            </div>
            {/* End .col-xl-8 */}
        ...
        <div className="container">
          <div className="pt-40 border-top-light">
            <div className="row x-gap-40 y-gap-40">
              <div className="col-auto">
                <h3 className="text-22 fw-500">Чухал мэдээлэл</h3>
              </div>
            </div>
            {/* End row */}
            <ImportantInfo />
      ...
      <section className="border-top-light  mt-40 pt-40">
        <div className="container">
          <h3 className="text-22 fw-500 mb-20">Байршил</h3>
          ...
          <div className="pt-40 border-top-light">
            <div className="row y-gap-20">
              <div className="col-lg-4">
                <h2 className="text-22 fw-500">Түгээмэл асуулт хариулт</h2>
              </div>
              {/* End .row */}
          ...
          <div className="row y-gap-20 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Бусад аялалууд</h2>
